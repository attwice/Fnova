...
const PrivacyPolicy = () => (
  <div className="privacy-policy flex flex-column">
    ...
    <span>
      ...
      <a href="https://thepinzone.com/">stickercove.com</a> (the “Site”).
    </span>
    <div className="privacy-policy-section">
      ...
      <p>
        ...
        browse the Site. Additionally when you make a purchase or attempt to
        make a purchase through the Site, we collect certain information from
        ...
        number. We refer to this information as “Order Information.” When we
    ...
    <div className="privacy-policy-section">
      ...
      <p>
        ...
        <a href="https://www.shopify.com/legal/privacy">www.shopify.com</a>. We
        ...
        <a href="https://tools.google.com/dlpage/gaoptout">tools.google.com</a>.
    ...
    <div className="privacy-policy-section">
      ...
      <p className="flex flex-column">
        ...
        You can opt out of targeted advertising by: COMMON LINKS INCLUDE:
        ...
        <a href="http://optout.aboutads.info/">optout.aboutads.info</a>.
      </p>
    </div>
    <div className="privacy-policy-section">
    ...
    <div className="privacy-policy-section">
      ...
      <p>
        ...
        info@rocketshark.sc or by mail using the details provided below: 655H
        Fairview Rd., Ste 109, Simpsonville, SC, 29680, United States
      </p>
    </div>
  </div>
)
